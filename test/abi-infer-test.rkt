...
"))
    ...
    (check-true (bitset-member? h-def 0)))
...
"))
    ...
    (check-false (bitset-member? defs-a 30))
    ...
    (check-true (bitset-member? defs-b 30))
...
"))
    ...
    (check-not-false info-a)
    (define defs-a (inferred-abi-gpr-def (function-abi-info-inferred-abi info-a)))
    (check-true (bitset-member? defs-a 0))
...
"))
    ...
    (check-not-false info-b)
    (define defs-b (inferred-abi-gpr-def (function-abi-info-inferred-abi info-b)))
    (check-true (bitset-member? defs-b 19))
    (check-false (bitset-member? defs-b 0)))
...
"))
    ...
    (check-true (bitset-member? def-a 0))
    (check-false (bitset-member? def-a 5))
    (check-true (bitset-member? def-b 5))
    (check-false (bitset-member? def-b 0))))
...
"))
    ...
    (check-true (bitset-member? ping-def 0))
    (check-true (bitset-member? pong-def 0)))
...
"))
    ...
    (define a-def (inferred-abi-gpr-def
                    (function-abi-info-inferred-abi
                      (hash-ref abi-map 'a))))
    (check-true (bitset-member? a-def 0)))
...
"))
    ...
    (define b2-def (inferred-abi-gpr-def
                     (function-abi-info-inferred-abi
                       (hash-ref abi-map 'b2))))
    (check-true (bitset-member? a2-def 0))
    (check-true (bitset-member? b2-def 1))))
