...
;;
;; 运行: racket cli/as.rkt examples/05-virtual-reg.lisp

;; ------------------------------------------------------------
;; 基本虚拟寄存器使用
;; 分配器会选择合适的物理寄存器
;; ------------------------------------------------------------
(: function basic_virtual)
(: label entry)
  ;; 使用虚拟寄存器, 让分配器决定物理寄存器
  (mov x.a 1)               ; x.a = 1
  (mov x.b 2)               ; x.b = 2
